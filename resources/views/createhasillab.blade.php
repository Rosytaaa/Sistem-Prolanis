            ...
            <div class="my-3 p-3 bg-body rounded shadow-sm">
                <div class="row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="date" class="form-control w-25" name="tanggal_pemeriksaan" id="tanggal_pemeriksaan" value="{{ old('tanggal_pemeriksaan') }}" required>
                        </div>
                    </div>
                    ...
                    <div class="w-50 mt-5">
                        <table class="table table-striped">
                            ...
                            <tbody id="tbody_hasil">
                                @if (old('jenis_pemeriksaan'))
                                    @foreach (old('jenis_pemeriksaan') as $index => $jenis)
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                                            <td>
                                                {{ $jenis }}
                                            ...
                                            <td>
                                                {{ old('hasil_pemeriksaan')[$index] }}
                                                <input type="hidden" name="hasil_pemeriksaan[]" value="{{ old('hasil_pemeriksaan')[$index] }}">
                                            </td>
                    ...
                    <div class="mb-3 row mt-5">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" value="{{ old('Catatan') }}"name="catatan" id="catatan" rows="3" placeholder="Opsional..."></textarea>
                        </div>
                    </div>
