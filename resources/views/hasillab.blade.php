    ...
    <div class="d-flex min-vh-100">
        ...
        <main class="flex-grow-1 bg-light p-4">
            ...
            <ol class="breadcrumb mb-4 ms-4">
                <li class="breadcrumb-item">Data Hasil Lab</li>
            </ol>
            ...
            <div class="my-3 p-3 bg-body rounded shadow-sm">
               ...
               <div class="d-flex justify-content-between align-items-center mb-4 mt-4 flex-wrap gap-2">
                    <form class="d-flex" action="{{ url('hasillab') }}" method="get">
                    ...
                    <form action="{{ url('hasillab') }}" method="get" class="d-flex align-items-center gap-2">
                ...
                <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="{{ url('/import-hasillab') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                ...
                <div class="d-flex justify-content-between align-items-center mt-5 mb-2">
                    ...
                    <div>
                        ...
                        <a href="/export-hasillab" class="btn btn-danger me-2">
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 20%;">Hasil Lab</th>
                    ...
                    <tbody>
                        ...
                        <tr onclick="window.location='{{ route('hasillab.show', $item->id) }}'" style="cursor: pointer;">
                            ...
                            <td class="text-nowrap">
                                <a href="{{ url('hasillab/' .$item->id. '/edit') }}" class="fa-regular fa-pen-to-square btn btn-warning btn-sm"></a>
                                <form onsubmit="return confirm('Apakah kamu yakin ingin menghapus data ini?')" class='d-inline' action="{{ url('hasillab/'. $item->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
