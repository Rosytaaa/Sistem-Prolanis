            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="card">
                        <div class="container">
                            <div class="card-body">
                                ...
                                <h5 class="mt-5 mb-3">Jadwal Pemeriksaan</h5>
                                <div class="col-md-6">
                                    <div class="d-flex mb-2">
                                        <div class="fw-semibold me-2" style="width: 180px;">Tanggal Pemeriksaan</div>
                                        <div class="me-2">:</div>
                                        @php
                                            $jadwal = \Carbon\Carbon::parse($data->jadwal_pemeriksaan);
                                    ...
                                    <div class="d-flex mb-2">
                                        <div class="fw-semibold me-2" style="width: 180px;">Jam Pemeriksaan</div>
                                        <div class="me-2">:</div>
                                        @php
                                            $jadwal = \Carbon\Carbon::parse($data->jadwal_pemeriksaan);
                                            $tanggal = $jadwal->format('d F Y');
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="{{ route('jadwalkunjungan.index') }}" class="btn btn-secondary m-3">Kembali</a>
                    </div>
                    </div>
                </div>
            </section>
