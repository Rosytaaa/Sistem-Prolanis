...
<div class="d-flex">
    <aside class="sidebar d-flex flex-column flex-shrink-0 p-3 bg-white">
        ...
        <div class="dropdown">
            <a href="#" class="dropdown-toggle d-flex align-items-center text-decoration-none" data-bs-toggle="dropdown">
                <img src="/img/profile.png" alt="" width="40" height="30" class="rounded-circle me-auto">
    ...
    <div class="container bg-light">
        <h2 class="mt-4 ms-4">Edit Data Pasien</h2>
    ...
    <body class="bg-light">
        <main class="container">
           ...
           @if ($errors->any())
           <div class="pt-3">
               <div class="alert alert-danger w-auto" style="display: inline-block;">
                   <ul>
       ...
       @endif
           {{-- <form action="{{ url('pasien') }}" method="post"> --}}
            <form action="{{ url('menupasien/'. $data->no_bpjs) }}" method="post">
            @csrf
            @method('PUT')
            <div class="my-3 p-3 bg-body rounded shadow-sm">
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name='no_bpjs' id="no_bpjs" value="{{$data->no_bpjs}}">
                    </div>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select" name="jenis_kelamin" id="jenis_kelamin" value="{{ $data->jenis_kelamin }}required >
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select" name="keterangan" id="keterangan" value="{{ $data->keterangan}} required>
                            <option value="">-- Pilih Keterangan --</option>
                            <option value="Diabetes" {{ old('keterangan') == 'Diabetes' ? 'selected' : '' }}>Diabetes Melitus</option>
