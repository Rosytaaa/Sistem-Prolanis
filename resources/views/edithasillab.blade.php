            ...
            <ul class="nav nav-pills flex-column">
                ...
                <li>
                    ...
                    <div class="submenu" id="pemeriksaanMenu">
                        <a href="/hasillab" class="nav-link toggle-menu active">Hasil Lab</a>
        ...
        <div class="container bg-light">
            ...
            <body class="bg-light">
                <main class="container">
                    ...
                    @endif
                    <form action="{{ url('hasillab/' .$hasillab->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="search_pasien" class="form-control" placeholder="Ketik No BPJS atau Nama" value="{{ $hasillab->pasien?->no_bpjs ?? $hasillab->no_bpjs ?? '' }}">
                                        <input type="hidden" name="no_bpjs" id="no_bpjs" value="{{ $hasillab->pasien?->no_bpjs ?? $hasillab->no_bpjs ?? '' }}">
                                        <div id="list_pasien" class="list-group mt-1" style="position: absolute; z-index: 1000;"></div>
                                        @if (!$hasillab->pasien)
                                            <small class="text-danger">* Pasien terkait sudah dihapus dari data pasien.</small>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="alamat_input" value="{{ $hasillab->pasien?->alamat ?? $hasillab->alamat ?? '' }}" name="alamat" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="nama_input" value="{{$hasillab->nama}}" name="nama" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="no_telepon" value="{{ $hasillab->pasien?->no_telepon ?? $hasillab->no_telepon ?? '' }}" name="no_telepon" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="tgl_lahir" value="{{ $hasillab->pasien?->tanggal_lahir ?? $hasillab->tanggal_lahir ?? '' }}" name="tanggal_lahir" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="jk_input" value="{{ $hasillab->pasien?->jenis_kelamin ?? $hasillab->jenis_kelamin ?? '' }}" name="jenis_kelamin" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="keterangan" value="{{$hasillab->keterangan}}"name="keterangan" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                            <h5 class="mt-5 mb-4">Hasil Pemeriksaan </h5>
                            <div class="mb-3 row">
                                <label for="tanggal_pemeriksaan" class="col-sm-2 col-form-label">Tanggal Pemeriksaan</label>
                                <div class="col-sm-10">
                                    <input type="date" class="form-control w-25" name="tanggal_pemeriksaan" id="tanggal_pemeriksaan" value="{{ $hasillab->tanggal_pemeriksaan }}" required>
                                </div>
                            </div>
                            <div class="row align-items-end mt-5">
                                <div class="col-md-4">
                                    <label class="form-label">Jenis Pemeriksaan</label>
                                    <input type="text" id="jenis_pemeriksaan" name="jenis_pemeriksaan" class="form-control">
                                </div>
                                <div class="col-md-5 d-flex">
                                    <div class="flex-grow-1">
                                        <label class="form-label">Hasil Pemeriksaan</label>
                                        <input type="text" id="hasil_pemeriksaan" name="hasil_pemeriksaan" class="form-control">
                                    </div>
                            ...
                            <div class="w-50 mt-5">
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 10%;">Hasil Pemeriksaan</th>
                                            <th style="width: 10%;" class="text-nowrap">Aksi</th>
                                        </tr>
                                    </thead>
                                    <tbody id="tbody_hasil">
                                        @foreach ($hasillab->hasil_array ?? [] as $index => $data)
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
                                                <td>
                                                    {{ $data['jenis'] }}
                                                    <input type="hidden" name="jenis_pemeriksaan[]" value="{{ $data['jenis'] }}">
                                                </td>
                                                <td>
                                                    {{ $data['hasil'] }}
                                                    <input type="hidden" name="hasil_pemeriksaan[]" value="{{ $data['hasil'] }}">
                                                </td>
                                                <td class="text-nowrap">
                                                <button type="button" class="btn btn-danger btn-sm p-1" style="width: 30px; height: 30px;" onclick="hapusBaris(this)">
                                ...
                                <div class="mb-3 row mt-5">
                                    ...
                                    <div class="col-sm-10">
                                    <textarea class="form-control" name="catatan" id="catatan" rows="3" placeholder="Opsional...">{{ $hasillab->catatan }}</textarea>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-center gap-3 mt-4">
                                <button type="submit" class="btn btn-primary" name="submit">Simpan</button>
                                <a href="{{ route('hasillab.index') }}" class="btn btn-secondary">Kembali</a>
                                </div>
                            </div>
                        </div>
                    </div>
