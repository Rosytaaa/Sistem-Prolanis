        ...
        <div class="container bg-light">
            ...
            <body class="bg-light">
                <main class="container">
                    ...
                    @endif
                    <form action="{{ route('jadwalkunjungan.update', $jadwal->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="search_pasien" class="form-control" placeholder="Ketik No BPJS atau Nama" value="{{ $jadwal->pasien?->no_bpjs ?? $jadwal->no_bpjs ?? '' }}">
                                        <input type="hidden" name="no_bpjs" id="no_bpjs" value="{{ $jadwal->pasien?->no_bpjs ?? $jadwal->no_bpjs ?? '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="alamat_input" value="{{ $jadwal->pasien?->alamat ?? $jadwal->alamat ?? '' }}" name="alamat" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="nama_input" value="{{ $jadwal->nama }}" name="nama" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="no_telepon" value="{{  $jadwal->no_telepon }}"name="no_telepon" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="tgl_lahir" value="{{ $jadwal->pasien?->alamat ?? $jadwal->alamat ?? ''}}"name="tanggal_lahir" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="jk_input" value="{{ $jadwal->pasien?->jenis_kelamin ?? $jadwal->jenis_kelamin?? ''}}"name="jenis_kelamin" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="keterangan" value="{{ $jadwal->keterangan}}"name="keterangan" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="datetime-local" name="jadwal_pemeriksaan" value="{{ $jadwal->jadwal_pemeriksaan}}"name="jadwal_pemeriksaan" class="form-control" id="jadwal_pemeriksaan">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3 row mt-5">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="catatan" id="catatan" rows="3" placeholder="Opsional...">{{ $jadwal->catatan }}</textarea>
                                </div>
                            </div>
